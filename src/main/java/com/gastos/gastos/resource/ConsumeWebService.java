...
public class ConsumeWebService {
   ...
   /*
    * método para buscar um album na api do spotify e salvar no banco como entidade disco
    */
   ...
   public List<Disco> getAllByGenres() {
      ...
      HttpHeaders headers = new HttpHeaders();
      headers.setAccept(Arrays.asList(MediaType.APPLICATION_JSON));
      headers.add("Authorization", "Bearer BQCHcn1XZUM0zTdf9_unnPXFsp3K5wXHdul7VgX09109nSPWSTLdrUNgLoEnffm940aJSjibX3JG9CQpEMkjP9dcjKSQcP0lrtHJi6XpDWm16bpSYnC7QOa9UVdxM1dzVNTf0Q0RC6gsQ2VANT-qPMnc9koX25dKyRxy");
      HttpEntity <Disco> entity = new HttpEntity<Disco>(headers);
